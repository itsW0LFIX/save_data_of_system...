...
public class app {
    ...
    public static void main(String[] args) {
        ...
        for (String s : Arrays.asList("0: Login","1: Forms.", "2: Student.",
...
//                        returnmenu(args);
                    ...
                    case 3 -> {
                      //  sendMessageToEmail(args);
                        System.out.println("soon !! ");
                        ForgetPassword forgetPassword = new ForgetPassword();
                        forgetPassword.show();
                    }
                    case 4 -> {
                        CreatAcount creatAcount = new CreatAcount();
                        creatAcount.show();
...
//                        login.show();
    ...
    // send email //
//    public static void sendMessageToEmail(String[] args) {
...
//                    InternetAddress.parse("devopscode9@gmail.com"));
