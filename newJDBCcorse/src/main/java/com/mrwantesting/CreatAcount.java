...
public class CreatAcount extends javax.swing.JFrame {
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String name = jTextFieldName.getText().trim(); // Trim to remove leading and trailing spaces
        String email = jTextFieldEmail.getText().trim(); // Trim to remove leading and trailing spaces
        ...
        try {
            ...
            PreparedStatement stm = con.prepareStatement("SELECT * FROM logup WHERE email=?");
            stm.setString(1, email);
            ResultSet rs = stm.executeQuery();

            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "You already have an account with this email.");
                return;
            } else {
